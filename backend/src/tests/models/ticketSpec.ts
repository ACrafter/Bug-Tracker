...
describe("Ticket Model Tests", () => {
    ...
    describe("CRUD Methods Functionality", () => {
        ...
        it("Create Method", async () => {
            const res = await P.create({title: "test ticket", ticket_type: "new feature", ticket_description:"ticketDesc", projectid:projectId})
            ticketId = res.id as Number;
            expect(res).toEqual({id: ticketId, title: "test ticket", ticket_type: "new feature", ticket_description:"ticketDesc", projectid:projectId, ticket_status:"Open", last_check: null})
        })
        ...
        it("Update Method", async () => {
            ...
            expect(res).toEqual({id: ticketId, title: "test ticket", ticket_type: "new feature", ticket_description:"ticketDesc", projectid:projectId, ticket_status:"Closed", last_check: null})
        })
